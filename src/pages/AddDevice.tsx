  ...
  return (
    <div className="max-w-[1024px] w-full mx-auto space-y-6">
      <div className="flex items-center gap-4 mb-4">
        <button
          onClick={goBack}
          className="p-2 -ml-2 text-slate-800 dark:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full transition-colors"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1 border-2 border-indigo-900 bg-indigo-900 rounded-[2.5rem] p-8 flex flex-col justify-between text-white relative overflow-hidden group">
            ...
            <div className="relative z-10 w-full">
              ...
              <p className="text-indigo-300/60 text-[11px] text-center mt-2">
                Use Chrome for best experience. Firefox may block the file
                picker.
              </p>
            </div>
            {/* Decorative Elements */}
      ...
      {(step === "DETAILS" || step === "MANUAL") && !loading && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <form
            onSubmit={saveDevice}
            className="space-y-5 bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] shadow-sm border-2 border-slate-200 dark:border-slate-800"
          >
            {step === "MANUAL" && (
              <>
                <div>
