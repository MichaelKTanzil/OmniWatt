...
import { Zap, User as UserIcon, Mail, Lock, EyeOff, Eye, Sun, Moon } from 'lucide-react';
...
export default function AuthPage({ mode }: { mode: 'login' | 'signup' }) {
  ...
  return (
    <div className="min-h-screen flex flex-col pt-16 px-8 items-center bg-slate-50 dark:bg-slate-950 relative">
      <button
        onClick={toggleTheme}
      ...
      <div className="flex justify-center items-center gap-2 mb-10 bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-800 px-6 py-3 rounded-2xl shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-sm space-y-4 bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border-2 border-slate-200 dark:border-slate-800 shadow-sm">
