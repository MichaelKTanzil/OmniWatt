  ...
  return (
    <div className="max-w-[1024px] w-full mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 auto-rows-min">
        {/* Main Chart Card */}
        <div className="lg:col-span-8 bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-800 rounded-[2.5rem] p-8 relative overflow-hidden">
          <div className="flex justify-between items-start mb-6">
            <div>
              <h3 className="text-lg font-bold">Usage Trend</h3>
              <p className="text-slate-400 dark:text-slate-400 text-sm">Monthly load monitoring</p>
            </div>
            <div className="flex gap-2">
              <span className="text-[10px] font-bold px-3 py-1 bg-slate-100 dark:bg-slate-800 rounded-full text-slate-500 dark:text-slate-400 uppercase tracking-widest">Trend</span>
            </div>
          </div>
          {/* Usage Trend Chart */}
